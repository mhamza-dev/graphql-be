defmodule CommunityWeb.SubscriptionCase do
  ...
  using do
    quote do
      use CommunityWeb.ChannelCase
      use Absinthe.Phoenix.SubscriptionTest, schema: CommunityWeb.Schema

      import CommunityWeb.GraphQlHelpers

      defp create_socket(params \\ %{}) do
        {:ok, socket} = ChannelTest.connect(CommunityWeb.UserSocket, params)
